					...
					<div className="xl:flex items-center hidden">
						<ul className="flex items-center space-x-10 mr-12 relative">
							<Link href="/posts/create">
								<a className="font-inter text-red-500 p-3 bg-red-100 rounded-md drop-shadow-sm hover:bg-red-200 font-semibold hover:text-red-600 hover:drop-shadow-lg">
									Create Post
								</a>
							</Link>
							<Link href="#">
								<a className="fill-current text-gray-800 transition-all hover:text-red-500">
								...
								<div className="dropdown inline-block relative mt-1">
									<button className="cursor-pointer relative">
										<div className="w-[50px] h-[50px]">
											<img
												src={
													userData.userImage !== "" ? userData.userImage : user?.userImage
												}
												alt={userData.userName !== "" ? userData.userName : user?.userName}
					...
					<Link href="/profile">
						<a onClick={() => setOpen(false)}>
							<div className="w-[100px] h-[100px] mx-auto my-10 z-10 userImageNav relative drop-shadow-lg">
								<img
									src={userData.userImage !== "" ? userData.userImage : user?.userImage}
									alt={userData.userName !== "" ? userData.userName : user?.userName}
